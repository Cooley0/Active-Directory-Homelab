...
## Network Diagram
![Network Diagram](screenshots/Network%20Diagram.png)
...
![input.conf](screenshots/01%20Input.conf%20Configuration.png)

### Splunk Indexes (endpoint index created)
![Splunk Indexes](screenshots/02%20Splunk%20Indexes.png)

### Splunk Recieving Port (9997)
![Receiving Port](screenshots/03%20Splunk%20Receiving%20Port.png)

### Splunk Recieving Events from target-PC (host + sources confirmed)
![Host Confirmed](screenshots/04%20Splunk%20Events%20from%20target-PC.png)

![Sources Confirmed](screenshots/05%20Splunk%20Event%20Sources.png)

### Splunk Receiving Events from Both Hosts (target-PC and ADDC01)
![Both Hosts](screenshots/06%20Splunk%20Both%20Hosts.png)
...
![AD DS Install](screenshots/07%20AD%20DS%20Installation.png)

### NTDS / SYSVOL Paths During Domain Controller Promotion
![NTDS Paths](screenshots/08%20NTDS%20-%20SYSVOL%20Paths.png)

### Creating Organizational Units and Users in AD
![AD Users](screenshots/09%20Creating%20AD%20Users.png)

### Windows 11 Joined to joseph.local Domain
![Domain Join](screenshots/10%20Windows%2011%20joining%20domain.png)

### Logging into Domain User (Jenny Smith) from target-PC
![Domain Login](screenshots/11%20Domain%20login%20(Jenny%20Smith).png)
...
![Kali IP](screenshots/12%20Kali%20Linux%20IP%20Config.png)

### Enabling RDP for Domain Users on target-PC
![RDP Users](screenshots/13%20Enabling%20RDP.png)

### passwords.txt Wordlist
![Password List](screenshots/14%20Password%20List.png)

### Hydra Brute Force Attack - Successful Credential Discovery
![Hydra Success](screenshots/15%20Hydra%20Successful%20Attack.png)
...
![tsmith Search](screenshots/16%20Splunk%20Search%20(tsmith).png)

### EventCode Breakdown (50x EventCode 4625 - Failed Log on)
![EventCode 4625](screenshots/17%20EventCode%20Breakdown.png)

### EventCode 4625 Logs - Rapidly Failed Attempts
![Failed Logons](screenshots/18%20EventCode%204625%20Failed%20Logon%20Attempts.png)

### EventCode 4624 - Successful Logon from Kali (192.168.10.250)
![Successful Logon](screenshots/19%20EventCode%204624%20Successful%20Logon%20from%20Kali.png)

### Logon Source Confirmed - Kali Machine IP
![Kali Source](screenshots/20%20Logon%20Source%20Confirmed.png)
...
![ART Install](screenshots/21%20AtomicRedTeam%20Installation.png)

![T1136 Command](screenshots/22%20T1136.001%20Command.png)

![T1136 Result](screenshots/23%20T1136.001%20Results.png)

#### Splunk Detection - NewLocalUser Account Creation
![NewLocalUser Splunk](screenshots/24%20Splunk%20Detection%20NewLocalUser.png)
...
![T1059 Command](screenshots/25%20T1059.001%20Command.png)

![T1059 Result](screenshots/26%20T1059.001%20Results.png)

#### Splunk Detection - PowerShell Telemetry
![PowerShell Splunk](screenshots/27%20Splunk%20Detection%20PowerShell%20Telemetry.png)

#### MITRE Technique IDs Detected in Splunk
![Technique IDs](screenshots/28%20MITRE%20Technique%20IDs.png)
